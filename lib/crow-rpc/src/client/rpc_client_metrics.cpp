...
{
    static Counter c("rpc.client.submit_ok.c");
    return c;
}

Counter &rpc_submit_fail()
{
    static Counter c("rpc.client.submit_fail.c");
    return c;
}

Counter &rpc_resp_matched()
{
    static Counter c("rpc.client.resp_matched.c");
    return c;
}

Counter &rpc_resp_missed()
{
    static Counter c("rpc.client.resp_missed.c");
    return c;
}

Counter &rpc_reaped()
{
    static Counter c("rpc.client.reaped.c");
    return c;
}

Counter &rpc_slab_fallback()
{
    static Counter c("rpc.client.slab_fallback.c");
    return c;
}
