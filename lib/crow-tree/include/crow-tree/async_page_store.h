...
// a caller-owned Reactor via io_uring, mapping global byte offsets to
...
// frame (no reactor, no I/O) needs no dedicated type.
#pragma once
...
// BlockPageStore's async twin: delegates all I/O to the Reactor using
...
// submit_fsync chains reactor fsync across all dirty extent fds.
