...
// Buffer pool: crow-tree's bounded, explicitly-managed cache of page frames.
...
#include "crow-tree/page_types.h" // kInvalidPageId
...
// moved to crow-common::metrics (R12); bridge the moved types into `crow-tree`
...
// `crow::common::metrics::Counter` rather than nesting under `crow::tree::`.
