...
//! What actually matters for C2 is that [`crowkv_client::CrowkvClient`]
...
//!
//! Two-node group (mirrors `crowkv/tests/testkit/cluster.rs::start_cluster_inner`,
...
/// `crowkv/tests/testkit/cluster.rs::start_cluster_inner`.
