...
Depends on: [`test-design.md`](test/test-design.md), [`design-storage-engine.md`](design/design-storage-engine.md)
...
- **Tombstone retention:** `tombstone_grace_slots = 0` (immediately reclaimable once both snapshot-slot and safe-slot watermarks pass) per [`design-storage-engine.md`](design/design-storage-engine.md) §10.
