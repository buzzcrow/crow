...
- [7. Zone Management](#7-zone-management) — detailed design in [`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md)
- [8. Disk Status Management](#8-disk-status-management)
- [9. Space Metrics](#9-space-metrics) — detailed design in [`design-crow-diskdb-space-metrics.md`](design-crow-diskdb-space-metrics.md)
- [10. Background Scanner](#10-background-scanner)
- [11. Crate Layout](#11-crate-layout)
- [12. Concurrency Model](#12-concurrency-model)
- [13. Non-Gaps (Good Fits with CROW)](#13-non-gaps-good-fits-with-crow)
...
reclaims freed space). All state changes are durably persisted to CROW
...
[`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md) §3.
...
- **Zone coordination** — the scanner skips active zones, acquires the
  ...
  [`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md) §9.
...
- **Allocate** — lock-free per-bit CAS on the usage bitmap; no
  ...
  [`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md) §4, §8.
- **Free** — persist-only: one `batch_write`, no bitmap touch, no
  zone-level lock. Free can run on any zone without coordination.
  Details in [`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md) §4, §8.
- **Zone-level lock for non-allocate operations** — compaction,
  ...
  [`design-crow-diskdb-zone-management.md`](design-crow-diskdb-zone-management.md) §8.
