...
| `doc/design/diskio/design-crow-diskio.md` | diskio root: per-node data I/O engine, IoEngine abstraction (UringEngine/BlockingEngine/DummyEngine/SimulatedEngine), shared reactor in crow-common, reactor topology + polling modes, bad-disk SQ isolation, RPC service + Rust client. |
