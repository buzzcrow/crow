...
//! real `crowdb-kv-server` upstreams via the console web backend.
//!
//! Flow:
//!   1. Spawn two `crowdb-kv-server` processes (n1, n2).
//!   2. Boot `crowdb-web` with both nodes in the config; seed the
