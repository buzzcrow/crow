use clap::Subcommand;
use crowkv_console_shared::clients::console::{ConsoleClient, ServerSummary};
use crowkv_console_shared::cluster::{GroupView, NodeHealth, StoreView};
...
fn fail(what: &str, e: &crowkv_console_shared::error::Error) -> ExitCode {
